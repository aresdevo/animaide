...
class AS_OT_sliders(Operator):
    ...
    def ease(self):
        ...
        local_y = self.right_neighbor.co.y - self.left_neighbor.co.y
        local_x = self.right_neighbor.co.x - self.left_neighbor.co.x

        for index in self.selected_keys:
            k = self.fcurve.keyframe_points[index]
            x = k.co.x - self.left_neighbor.co.x
            try:
            ...
            k.co.y = self.left_neighbor.co.y + local_y * ease_y
    ...
    def ease_in_out(self):
        ...
        for index in self.selected_keys:
            ...
            k.co.y = self.left_neighbor.co.y + local_y * ease_y.real
    ...
    def tween(self):
        ...
        local_y = self.right_neighbor.co.y - self.left_neighbor.co.y
        delta = local_y / 2
        mid = self.left_neighbor.co.y + delta
