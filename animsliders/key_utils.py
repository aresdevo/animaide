...
def linear_y(left_neighbor, right_neighbor, key):
    big_adjacent = right_neighbor.co.x - left_neighbor.co.x
    big_oposite = right_neighbor.co.y - left_neighbor.co.y
    tangent = big_oposite/big_adjacent

    adjacent = key.co.x - left_neighbor.co.x
    oposite = tangent * adjacent
    return left_neighbor.co.y + oposite
